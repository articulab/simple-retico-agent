...
class CoquiTTSInterruptionWhenChanges:
    ...
    def set_vad_state(self, vad_state):
        """Setter for vad_state parameter

        Args:
            vad_state (bool): the vad state received from the VAD module
        """
...
class CoquiTTSInterruptionWhenChangesModule(retico_core.AbstractModule):
    ...
    @staticmethod
    def input_ius():
        return [retico_core.text.TextIU, VADStateIU]
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.tts = CoquiTTSInterruptionWhenChanges(
    ...
    def process_update(self, update_message):
        ...
        for iu, ut in update_message:
            ...
            elif isinstance(iu, retico_core.text.TextIU):
                if ut == retico_core.UpdateType.ADD:
        ...
        # if final (punctuation), generate and send the corresponding audio chunk
